...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/vendor/modernizr.min.js":[function(require,module,exports) {
...
!function (n, e, o) {
  ...
  function s() {
    ...
    for (var u in f) {
      if (f.hasOwnProperty(u)) {
        if (n = [], e = f[u], e.name && (n.push(e.name.toLowerCase()), e.options && e.options.aliases && e.options.aliases.length)) for (o = 0; o < e.options.aliases.length; o++) {
          n.push(e.options.aliases[o].toLowerCase());
        }

        for (s = t(e.fn, "function") ? e.fn() : e.fn, i = 0; i < n.length; i++) {
          a = n[i], l = a.split("."), 1 === l.length ? Modernizr[l[0]] = s : (!Modernizr[l[0]] || Modernizr[l[0]] instanceof Boolean || (Modernizr[l[0]] = new Boolean(Modernizr[l[0]])), Modernizr[l[0]][l[1]] = s), r.push((s ? "" : "no-") + l.join("-"));
        }
      }
    }
  }
  ...
  function a(n, e) {
    if ("object" == _typeof(n)) for (var o in n) {
      ...
      e = "function" == typeof e ? e() : e, 1 == t.length ? Modernizr[t[0]] = e : (!Modernizr[t[0]] || Modernizr[t[0]] instanceof Boolean || (Modernizr[t[0]] = new Boolean(Modernizr[t[0]])), Modernizr[t[0]][t[1]] = e), i([(e && 0 != e ? "" : "no-") + t.join("-")]), Modernizr._trigger(n, e);
    }
    return Modernizr;
  }
  ...
  !function () {
    ...
    l.addTest = a;
  }), s(), i(r), delete l.addTest, delete l.addAsyncTest;
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/vendor/modernizr.min.js"], null)
//# sourceMappingURL=/modernizr.min.ae5af34d.js.map